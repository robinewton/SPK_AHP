...
{
	function ambil_nilai_kriteria($idpemilihan_gedung,$dari,$tujuan)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function ambil_nilai_subkriteria($idpemilihan_gedung,$id_kriteria,$dari,$tujuan)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function peserta_nilai($IDpemilih_penyewa,$id_kriteria)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function ambil_prioritas($IDpemilihan_gedung,$subkriteriaID)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
