...
$(document).ready(function(){
    ...
    $("#formphoto").submit(function(e){
        ...
        $.ajax({
            url: '<?=base_url();?>profil/uploadfile',
            type: 'POST',
            dataType:'JSON',
            data: formData,
            async: true,
...
<div class="form-group required">
	<label class="col-sm-4 control-label" for="">Instansi</label>
	<div class="col-md-7">
		<input type="text" name="instansi" id="" class="form-control " autocomplete="" placeholder="Nama Instansi" required="" value="<?php echo set_value('instansi'); ?>"  />	
	</div>
</div>
<div class="form-group">
	<label class="col-sm-4 control-label" for="">Berkas</label>
	<div class="col-md-7">
		<!--<span  style="margin-top: 5px" class="btn btn-link">Upload</span>-->
		<input type="file" name="file" id="file" />
		<small class="text-info">Maksimal 3MB</small>
	</div>
</div>
<?php  //if($status = ''){ ?>
<?php //}else{?>
...
<div class="form-group">
	...
	<div class="col-md-7">
		<!--<button type="submit" class="btn btn-primary btn-flat" onclick=""><i class="fa fa-plus"></i></button>-->
...
<div class="col-md-6">
	<div class="alert alert-info alert-dismissible">
        ...
        <h4 style="color:#800000"><img src="<?php echo base_url(); ?>konten/images/logo.png" style="width:50px;height:50px">Peringatan / <small><i style="color:#800000"> Alert :</i></small></h4>
		 ...
		 Data pesanan akan diterima oleh pihak UPT. Taman Budaya Jawa Timur. Dan Jika telah dilihat maka akan ada WA/SMS dari pihak UPT. Taman Budaya Jawa Timur. <br> <b><small>Catatan : Pemesanan Gedung untuk instansi wajib mengupload berkas dan nama instansi yang terkait. Jika belum ada status persetujuan, anda wajib mengirim pemberitahuan melalui email kami dan <i>capture</i> bukti pemesanan pada website kami. </small></b></p>			
        <div class="form-group">
