...
echo form_open(base_url('profil/updatePenyewa'),array('class'=>'form-horizontal'));
?>
<div class="form-group required">
	<label class="col-sm-2 control-label" for="">Nama</label>
	<div class="col-md-6">
		<input type="text" name="nama" id="" class="form-control " autocomplete="" placeholder="Nama Administrator" required="" value="<?php echo set_value('nama',user_info('nama')); ?>" readonly/>
	</div>
</div>
