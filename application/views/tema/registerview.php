  ...
  <nav class="navbar navbar-inverse navbar-static-top">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <small class="text-info" style="color:#5cb85c">Create your free account:</small>
          <!--<div class="form-group has-feedback">
            <label for="InputUsername1">Nama</label>
            <input type="text" name="nama" class="form-control" placeholder="nama" value="Penyewa" readonly="">
            <span class="fa fa-user-plus form-control-feedback"></span>
          </div>-->
          <div class="form-group has-feedback">
            <label for="InputPassword1">Username</label>
            <input type="hidden" name="nama" class="form-control" placeholder="nama" value="Penyewa" readonly="">
            <input type="hidden" name="akses" class="form-control" placeholder="akses" value="penyewa" readonly="">
          ...
          <div class="form-group has-feedback">
            ...
            <input type="text" name="akses" class="form-control" placeholder="akses" value="penyewa" readonly="">
          ...
          <div class="row">                      
            <div class="col-xs-4">
              <button type="submit" class="btn btn-warning btn-block btn-flat">Register</button><br>
            </div>
            <!-- /.col -->
          </div>
        </form>
