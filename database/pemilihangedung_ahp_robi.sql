...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2017 at 08:49 AM
...
--
-- Table structure for table `jenis_gedung`
--
...
--
-- Dumping data for table `jenis_gedung`
--
...
--
-- Dumping data for table `pemesanan_gedung`
--
...
--
-- Table structure for table `pemilihan_gedung`
--

CREATE TABLE `pemilihan_gedung` (
  `id_pemilihan_gedung` int(11) NOT NULL,
  `id_gedung` int(11) NOT NULL,
  `id_jenis_gedung` int(11) NOT NULL,
...
--
-- Dumping data for table `pemilihan_gedung`
--
...
--
-- Table structure for table `pemilih_penyewa`
--

CREATE TABLE `pemilih_penyewa` (
...
--
-- Dumping data for table `pemilih_penyewa`
--
...
--
-- Table structure for table `pengembalian_gedung`
--

CREATE TABLE `pengembalian_gedung` (
  `id_pengembalian` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `id_gedung` int(11) NOT NULL,
  `nama_pengembali_gedung` varchar(255) NOT NULL,
  `ktp_pengembalian_gedung` varchar(25) NOT NULL,
  `alamat_pengembali_gedung` varchar(255) NOT NULL,
  `pekerjaan_pengembali_gedung` varchar(50) NOT NULL,
  `tlp_pengembali_gedung` varchar(50) NOT NULL,
  `tanggal_pengembalian` date DEFAULT NULL,
  `jam_pengembalian` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pengembalian_gedung`
--

INSERT INTO `pengembalian_gedung` (`id_pengembalian`, `user_id`, `id_gedung`, `nama_pengembali_gedung`, `ktp_pengembalian_gedung`, `alamat_pengembali_gedung`, `pekerjaan_pengembali_gedung`, `tlp_pengembali_gedung`, `tanggal_pengembalian`, `jam_pengembalian`) VALUES
(1, 1, 0, 'A.R. Bagas Danang Haditio, S.Kom.', '12410100190', 'Jl. Fabregas', 'PNS', '082298112795', '2017-07-31', '11:43:00'),
(2, 1, 0, 'Risky Fitri Islamiati, S.Kom.', '13410100054', 'Jl. Jawa', 'PNS', '082298112795', '0000-00-00', '13:36:00'),
(3, 1, 0, 'A.R. Bagas Danang Haditio, S.Kom.', '12410100190', 'Jl. Fabregas', 'PNS', '082298112795', '0000-00-00', '13:37:00'),
(4, 1, 2, 'A.R. Bagas Danang Haditio, S.Kom.', '12410100190', 'Jl. Fabregas', 'PNS', '082298112795', '0000-00-00', '13:42:00');
...
(6, 'Pangestika', 'ayu', 'ca8692aabeb75728837836763de05b8c', 'penyewa', ''),
(7, 'Administrator', 'Danang', 'ca8692aabeb75728837836763de05b8c', 'penyewa', '');
...
--
-- Indexes for table `pengembalian_gedung`
--
ALTER TABLE `pengembalian_gedung`
...
--
ALTER TABLE `pemesanan_gedung`
  MODIFY `id_pemesanan_gedung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `pengembalian_gedung`
--
ALTER TABLE `pengembalian_gedung`
...
--
-- Constraints for table `pengembalian_gedung`
--
ALTER TABLE `pengembalian_gedung`
  ADD CONSTRAINT `pengembalian_gedung_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `pengguna` (`user_id`),
  ADD CONSTRAINT `pengembalian_gedung_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `gedung` (`id_gedung`);
